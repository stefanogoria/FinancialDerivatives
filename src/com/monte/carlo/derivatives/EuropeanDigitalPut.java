...
public class EuropeanDigitalPut implements Option {

	public	EuropeanDigitalPut(double Spot_, double Strike_, double r_, double d_, double T_, double vol_){
		Spot = Spot_;
		Strike = Strike_;
		r = r_;
		d = d_;
	...
	public double getPrice() {
		...
		return exp(-r*Expiry)*(1-Normals.CumulativeNormal(d2));
	}
	...
	public double getTheta() {
		// TODO Auto-generated method stub
		return + r*exp(-r*Expiry)*(1-Normals.CumulativeNormal(d2))
	...
	public double getRho() {
		// TODO Auto-generated method stub
		return -Expiry*exp(-r*Expiry)*(1-Normals.CumulativeNormal(d2))
